...
final pageBuilderMap = <String, Future<Widget> Function(Map<String, dynamic>)>{
  ...
  'features': (data) async => FeaturesWidget(),
  'login': (data) async => LoginWidget(),
  'media': (data) async => MediaWidget(),
  'diary': (data) async => DiaryWidget(),
  'invoices': (data) async => InvoicesWidget(),
  'mediator': (data) async => MediatorWidget(),
