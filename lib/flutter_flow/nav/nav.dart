...
class AppStateNotifier extends ChangeNotifier {
  ParentThingFirebaseUser? initialUser;
  ParentThingFirebaseUser? user;
  ...
  void update(ParentThingFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? ProfileWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'mediator',
              requireAuth: true,
              builder: (context, params) => MediatorWidget(),
            ),
            FFRoute(
              name: 'help',
              path: 'help',
